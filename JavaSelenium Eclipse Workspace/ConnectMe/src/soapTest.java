...
public class soapTest {
    ...
    static final String[] PASSWORD       = {"xxxxxxxxZvYjYOghwL4qHIYoAxx3Ph9F","xxxxxxxxeVkHEbJLJyo6pt3Mi4y00quq","xxxxxxxxW9idqnciHMUL2vKNMatvtgt1J","xxxxxxxxUq4nMj8pRm4AOHYu0M1Z04ln","xxxxxxxxi38HnGyA96Xi7ebN0imy1XijV","xxxxxxxxAo7sNVUGsRcLWswXyQOu4m2MA"};
...
//             deleteLeads();                  // Delete Leads in Salesforce
 			...
 			File csvFile = new File("C:/Users/rstiles/Documents/reptest.csv");  
 			if (csvFile.isFile()) {
 				try (BufferedReader br = new BufferedReader(new FileReader("C:/Users/rstiles/Documents/reptest.csv"))) {
 					String line;
 					String[] fields = null;
 				...
 				try {csvWriter = new FileWriter("C:/Users/rstiles/Documents/reptest.csv");				  
...
// mirror rep    			
    			if (repData[12].length() == 7 && repData[5].length() > 0 || repData[12].length() == 7 && repData[3].length() > 0 || repData[12].length() == 7 && repData[4].length() > 0) {
    				...
    				if (queryResults.getSize() > 1) {
    					...
    					usr = (User)queryResults.getRecords()[0];
    					usr.setId("");   	
